...
import br.com.letscode.service.mapper.UserMapper;
import br.com.letscode.web.rest.vm.ManagedUserVM;
...
class PlayerResourceIT {
    ...
    @BeforeEach
    public void setup() {
        cacheManager.getCache(PlayerRepository.USERS_BY_LOGIN_CACHE).clear();
        cacheManager.getCache(PlayerRepository.USERS_BY_EMAIL_CACHE).clear();
    }
     ...
     */
    public static Player initTestUser(PlayerRepository userRepository, EntityManager em) {
        Player user = createEntity(em);
    ...
    void createUser() throws Exception {
        ...
        assertPersistedUsers(users -> {
            ...
            Player testUser = users.get(users.size() - 1);
    ...
    void getUser() throws Exception {
        ...
        assertThat(cacheManager.getCache(PlayerRepository.USERS_BY_LOGIN_CACHE).get(user.getLogin())).isNull();
        ...
        assertThat(cacheManager.getCache(PlayerRepository.USERS_BY_LOGIN_CACHE).get(user.getLogin())).isNotNull();
    }
    ...
    void updateUser() throws Exception {
        ...
        // Update the user
        Player updatedUser = userRepository.findById(user.getId()).get();
        ...
        assertPersistedUsers(users -> {
            ...
            Player testUser = users.stream().filter(usr -> usr.getId().equals(updatedUser.getId())).findFirst().get();
    ...
    void testUserDTOtoUser() {
        ...
        Player user = userMapper.userDTOToUser(userDTO);
    ...
    private void assertPersistedUsers(Consumer<List<Player>> userAssertion) {
